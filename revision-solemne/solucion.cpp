...
Debe programar un método que **calcule cuántos movimientos realiza el jugador** desde la casilla 0 
hasta sobrepasar la casilla 99 (recuerde que el arreglo parte de la posición 0).
